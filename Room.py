...
class Room:
    ...
    def update_surrounding_cells(self, sorted_array, curr_copy_grid):
        copy_grid = copy.deepcopy(curr_copy_grid)
        ...
        for entry in surrounding:
            if entry[2] is not None:
                ...
                # copy_grid[i][j].concentration += 0.1
    ...
    def simple_spread(self):
        ...
        for i in range(0, iterations):
            copy_grid = copy.deepcopy(self.update_surrounding_cells(sorted_array, curr_copy_grid))
            curr_copy_grid = copy.deepcopy(copy_grid)
