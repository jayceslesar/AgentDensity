...
# y = get_rolling_average('p12_p21_p31.csv')
# z = get_rolling_average('p13_p21_p31.csv')
# t = [(i*100) + 1 for i in range(30)]


# fig = go.Figure()
# fig.add_trace(go.Scatter(x=t, y=x, mode='lines', name='p11_p21_p31' + ' min', marker_color='blue'))
# fig.add_trace(go.Scatter(x=t, y=y, mode='lines', name='p12_p21_p31' + ' max', marker_color='green'))
# fig.add_trace(go.Scatter(x=t, y=z, mode='lines', name='p13_p21_p31' + ' mean', marker_color='red'))
...
# imagename = os.path.join(os.getcwd(), "data", 'P1_Variation.svg')
# pio.write_image(fig, imagename, format='svg', width=1100, height=850)


x = auc_distrs_chunk('p11_p21_p31.csv')
y = auc_distrs_chunk('p12_p21_p31.csv')
z = auc_distrs_chunk('p13_p21_p31.csv')
